...
GigglebotLightSensors::GigglebotLightSensors(MicroBitI2C &_i2c)
    : i2c(_i2c), readings{0, 0}, counter(GIGGLEBOT_PERIOD_LIGHT_SENSORS -
                                         GIGGLEBOT_START_COUNT_LIGHT_SENSORS) {}

uint16_t GigglebotLightSensors::getLeftReading() { return this->readings[1]; }
...
void GigglebotLightSensors::idleTick() {
  ...
  MicroBitEvent e(GIGGLEBOT_ID_LIGHT_SENSORS,
